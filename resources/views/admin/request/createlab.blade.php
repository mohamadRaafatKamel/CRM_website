                ...
                <div class="card-content collapse show">
                    <div class="card-body">
                        ...
                        @if(isset($myorder->status_in_out) && $myorder->status_in_out != 4)
                            action="{{route('admin.request.update.lab', $myorder->id)}}" method="POST" 
                        @endif
                                ...
                                <div class="card-content collapse show">
                                    <div class="card-body">
                                        ...
                                        <div class="form-actions">
                                            ...
                                            @if(isset($myorder->status_in_out) && $myorder->status_in_out == 4)
                                                @if(\App\Models\Role::havePremission(['req_lab_reopen']))
                                                    <form class="form" action="{{route('admin.request.update.lab', $myorder->id)}}" 
                                                        method="POST">
                                                        @csrf
                                                        <button type="submit" name="btn" value="hold" class="btn btn-warning">
                                                            {{ __('Reopen') }}
