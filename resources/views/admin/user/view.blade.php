                    ...
                    <section id="basic-form-layouts">
                        <div class="row match-height">
                            <div class="col-md-12">
                                <div class="card">
                                    <div class="card-header">
                                        <h4 class="card-title" id="basic-layout-form">الشركاء</h4>
                                        <a class="heading-elements-toggle"><i
                                                class="la la-ellipsis-v font-medium-3"></i></a>
                                        <div class="heading-elements">
                                            <ul class="list-inline mb-0">
                                    ...
                                    <div class="card-content collapse show">
                                        <div class="card-body">
                                            <form class="form" action="{{route('admin.user.update',$user -> id)}}"
                                                ...
                                                @csrf
                                                <div class="form-body">
                                                    <h4 class="form-section"><i class="ft-home"></i> الشركاء </h4>
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                <label for="email"> {{ __('Organization Email') }} </label>
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                <label for="website"> {{ __('Organization Website') }} </label>
                                                ...
                                                <div class="form-actions">
                                                    <button type="submit" class="btn btn-primary" name="btn" value="partner">
                                                        <i class="la la-check-square-o"></i> تحديث
                                                    </button>
                                                </div>
                                            </form>
