                    ...
                    <div class="row breadcrumbs-top">
                        <div class="breadcrumb-wrapper col-12">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item"><a href="{{route('admin.specialty')}}">  التخصصات </a>
                                </li>
                                <li class="breadcrumb-item active">إضافة  تخصص
                                </li>
                            </ol>
                        </div>
                    </div>
                        ...
                        <div class="col-md-12">
                            <div class="card">
                                ...
                                <div class="card-content collapse show">
                                    <div class="card-body">
                                        <form class="form form-horizontal" action="{{route('admin.specialty.store')}}" method="POST"
                                            ...
                                            <div class="form-body">
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-6">
                                                        <input type="file" id="img_app" class="form-control"
                                                                   accept="image/*" name="img_app">
                                                            @error('img_app')
                                                            <span class="text-danger">{{$message}}</span>
                                                            @enderror
                                                    </div>
